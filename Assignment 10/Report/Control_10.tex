...
omega\_gc: 2.9470517025518097
phi\_m:42.294959125557
...
\section{Question 13}\label{question-13}}
 \begin{center}
    \adjustimage{max size={1\linewidth}{0.9\paperheight}}{bode13.png}
    \end{center}
    { \hspace*{\fill} \\}
 \begin{center}
    \adjustimage{max size={1.1\linewidth}{0.9\paperheight}}{time13.png}
    \end{center}
    { \hspace*{\fill} \\}
